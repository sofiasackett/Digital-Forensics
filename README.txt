...
Purpose:
jpegCheck.py traverses a given directory and looks for JPEG files and any appended data. 
...
How to Execute:
jpegCheck.py can be run from the command line on Windows by opening a command prompt with root privileges.

1. Within the command prompt, navigate to the location of the hw3Sackett.py file using cd.
2. Simply enter the name of the program <<jpegCheck.py>> and the program will begin.
